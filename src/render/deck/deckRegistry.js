...
//   suitColor(suit) -> string   (optional) the deck's color for the suit, used
//       by the foundation particle burst so each glyph matches the deck palette.
 ...
 * @property {(suit: string) => string} [suitColor]
