...
export default function Board() {
  ...
  const pilesGrid = (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, var(--card-width))', gap: 'clamp(4px, 0.6vw, 14px)', justifyContent: 'center', padding: 'clamp(8px, 2vw, 20px)', maxWidth: '100%' }}>
      {handedness === 'right'
