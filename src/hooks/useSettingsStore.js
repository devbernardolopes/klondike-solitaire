...
export const useSettingsStore = create((set, get) => ({
  ...
  init: async () => {
    ...
    const SETTING_KEYS = [
      ...
      'hoverGlow', 'cardShake', 'centisecondsOn', 'hoverLift', 'flipOvershoot', 'coinFly', 'autoComplete', 'seenThemeItemIds', 'seenAchievementIds', 'themeModalTab',
    ];
