-- submit_game_result — canonical body (mirrors klondike_supabase_migration_004.sql)
-- Return type is jsonb: { "newly_unlocked_achievement_ids": text[] }.
-- The two hardcoded achievement checks from the old version are replaced by
-- check_achievements(); every other side effect is unchanged.
